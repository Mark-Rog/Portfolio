...
Средняя выручка с пользователя в Москве и прочих регионах отличается не значительно! Средняя выручка с пользователя на разных тарифах отличается, пользователи более дорогого тарифа тратят больше.
